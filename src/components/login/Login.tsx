...
import { LOGINFORMLABEL, LOGINFORMMSGS, LOGINFORMNAME, ROUTESNAME, SUBMIT } from '../../helpers/constants';
        ...
        <div className="site-card-border-less-wrapper" id="login-wrapper">
            <Row style={{ display: 'flex', alignItems: 'center' }}>
                <Card style={{ width: "500px" }} headStyle={{ textAlign: 'center', fontSize: '22px', fontWeight: 600 }} title={ROUTESNAME.LOGIN.NAME} bordered={false}>
                    ...
                    >
                        <Form.Item
                            label={LOGINFORMLABEL.EMAIL}
                            name={LOGINFORMNAME.EMAIL}
                            rules={[
                                {
                                    required: true,
                                    type: "email",
                                    message: LOGINFORMMSGS.EMAIL,
                                },
                            ]}
                        >
                        ...
                        <Form.Item
                            label={LOGINFORMLABEL.PASSWORD}
                            name={LOGINFORMNAME.PASSWORD}
                            rules={[
                                {
                                    required: true,
                                    message: LOGINFORMMSGS.PASSWORD,
                                },
                            ]}
                        >
